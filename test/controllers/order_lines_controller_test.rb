...
class OrderLinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_line" do
    assert_difference('OrderLine.count') do
      post order_lines_url, params: { order_line: { namelo: @order_line.namelo, order_id: @order_line.order_id, scholarship_period_id: @order_line.scholarship_period_id, student_id: @order_line.student_id, type_scholarship_id: @order_line.type_scholarship_id } }
    end
  ...
  test "should update order_line" do
    patch order_line_url(@order_line), params: { order_line: { namelo: @order_line.namelo, order_id: @order_line.order_id, scholarship_period_id: @order_line.scholarship_period_id, student_id: @order_line.student_id, type_scholarship_id: @order_line.type_scholarship_id } }
