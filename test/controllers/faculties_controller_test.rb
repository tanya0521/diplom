...
class FacultiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post faculties_url, params: { faculty: { group_id: @faculty.group_id, namef: @faculty.namef } }
    end
  ...
  test "should update faculty" do
    patch faculty_url(@faculty), params: { faculty: { group_id: @faculty.group_id, namef: @faculty.namef } }
